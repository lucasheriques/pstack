...
- **My house rules.** A few defaults follow my own workflow instead of poteto's: `interrogate` gates every PR before it opens, and PRs open ready. Merging stays with the human. Comment cleanup never touches pre-existing comments.
