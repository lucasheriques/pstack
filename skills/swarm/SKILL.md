...
4. Pick the worker model from the `swarm workers` role in `${CLAUDE_SKILL_DIR}/../poteto-mode/references/models.md`. For a model race, name each arm's model up front.
