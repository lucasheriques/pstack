...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic. See **principle-type-system-discipline** and **principle-boundary-discipline** in poteto-mode's `principles/`.
...
Validate once where data crosses in. Trust types inside. See **principle-boundary-discipline**.
