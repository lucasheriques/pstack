...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation to a `pstack:poteto-agent` subagent on the `bug-fix` model from `references/models.md`, with a specific scope.
