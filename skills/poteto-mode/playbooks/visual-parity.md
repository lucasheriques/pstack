...
3. Migrate one component at a time. Parallelize across worktrees, one owner per component (**principle-separate-before-serializing-shared-state**). Shared primitives migrate first as a blocking phase.
