...
Read the principle's file in full for any principle you apply, for example `${CLAUDE_SKILL_DIR}/principles/principle-laziness-protocol.md`. Each entry names when it applies.
