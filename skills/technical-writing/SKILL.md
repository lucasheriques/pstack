...
- Apply the **unslop** skill (`${CLAUDE_SKILL_DIR}/../unslop/SKILL.md`) to every doc this skill touches. That skill owns the slop-pattern catalog: AI vocabulary, filler, hedging, formatting tells.
