...
- `Skill` tool calls, and `Read` tool calls against any `SKILL.md` file (project `.claude/skills/`, user-level `~/.claude/skills/`, or plugin paths under `~/.claude/plugins/`)
- Agent tool prompts that name a skill path
